...
export const instructorSchedule =
  (date, batch) => async (dispatch, getState) => {
    try {
      dispatch({
...
export const instructorUpdateBatchClass =
  (update, batchId, classId) => async (dispatch, getState) => {
    try {
      dispatch({
...
export const instructorUpdateBatchProject =
  (update, batchId, projectId) => async (dispatch, getState) => {
    try {
      const {
        userLogin: { userInfo },
      } = getState();
      ...
      const { data } = await axios
        ...
        .catch((e) => {
          console.log(e);
          // alert(
          //   "You can't enable this project for now. It will be enabled when you create a new batch"
          // );
...
export const updateClassLink =
  (updates, classId) => async (dispatch, getState) => {
    dispatch({
