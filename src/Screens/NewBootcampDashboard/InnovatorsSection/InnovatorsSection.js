...
function CreatorsSection() {
    ...
    return (
        <div className="dashboard_innovators_section">
            <div className="dashboard_innovators_title">
                Young Innovators at Rancho Labs
            </div>
            <ModalVideo
            ...
            <button className="btn_what_is" onClick={onClickHandler}  >What is Young Innovators Program?</button>
        </div>
    );
}
