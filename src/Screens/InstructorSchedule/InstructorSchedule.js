...
const AssignProject = (props) => {
  ...
  const handleDisability = () => {
    ...
    dispatch(
      instructorUpdateBatchProject(
        { isActive: false, lastDate: Date.now() },
        props.batchId,
        selectedProj
      )
    );
  ...
  return (
    <div className="isntructor__enableProjects">
      ...
      {props.projectDetails?.name && props.singleProjectDetails?.isActive ? (
        <>
          <ul>
          ...
          {edit && (
            <>
              ...
              >
                <option>Select Project to enable/disable</option>
              ...
              >
                <button
                  ...
                  onClick={handleProjectEnable}
                >
                  Enable
                </button>
                <button disabled={activeClass} onClick={handleDisability}>
                  Disable
                </button>
                {edit && (
                  <button
...
const Schedule = () => {
  ...
  bat = schedule?.classes?.filter((clas) => {
