...
import "./SummerCamp2022FAQ.css";
import arrow from '../../YoungInnovators/img/faqarr.png'
...
export default function FaqSection() {
  ...
  return (
    <div className="faq-section sc22_faq_section">
      <h2 className="faq_title sc22_faq_title" >
        All of your <span className="sc22_faq_questions" >Questions </span>at one place
      </h2>
          ...
          <div className="q-cont">
            {faqs.map((faq, i) => (
              ...
              >
                ...
                <p>{faq.question}</p>
                <LazyLoadImage src={arrow} alt="->" className="faq-arrow"/>
              </div>
            ))}
          </div>
          ...
          {faqs.map((faq, i) => (
            ...
            >
              ...
              >
                <i className="fas fa-circle faq-circle"></i>
                <p>{faq.question}</p>
                {expanded === i ? <LazyLoadImage src={arrow} alt="->" className="faq-arrow faq-arrow-down"/> : <LazyLoadImage src={arrow} alt="->" className="faq-arrow"/>}
              </AccordionSummary>
