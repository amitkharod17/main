    ...
    <div className="side-nav" ref={sideNav}>
      ...
      <div className="side-nav-links" ref={sideNavLinks}>
        ...
        <div className="email-icon">
          ...
          <span>
            <a href="mailto:info@rancholabs.com" className="email">
              info@rancholabs.com
            </a>
          </span>
        </div>
        {!userInfo ? (
          <div className="signup-login-btns">
            <div onClick={() => window.location.pathname.includes("/summercamp2022") ? goToPage("/summercamp2022-login") : goToPage("/login")}>
              <div>LOGIN</div>
            </div>
          </div>
        ) : (
